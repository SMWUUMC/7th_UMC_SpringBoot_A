...
//            List<MissionResponseDTO.MissionDetailDto> missions = missionService.findIndividualMissionByMissionStatus(new MissionRequestDTO.FindClaimableMissionDto(id, status, regionId));
//            for(MissionResponseDTO.MissionDetailDto dto : missions)
//                System.out.println(dto.getMissionId() + dto.getMissionSpec());
//
//            status = "COMPLETE";
//            System.out.println("완료 미션w");
//            missions = missionService.findIndividualMissionByMissionStatus(new MissionRequestDTO.FindClaimableMissionDto(id, status, regionId));
//            for(MissionResponseDTO.MissionDetailDto dto : missions)
//                System.out.println(dto.getMissionId() +dto.getMissionSpec());
//
//            status = "";
