...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1208771634L;
    ...
    public final com.example.demo.domian.QMission mission;

    public final EnumPath<com.example.demo.domian.enums.MissionStatus> status = createEnum("status", com.example.demo.domian.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new com.example.demo.domian.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
